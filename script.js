(() => {
  ...
  const API_BASE = "https://persona-mental-health-prediction.onrender.com";
  ...
  function renderResult(score) {
    ...
    animateNumber(scoreNumberEl, 0.0, score, 1300);
    ...
    if (clamped < 4) {
      scoreBandEl.classList.add("band-strained");
    } else if (clamped < 7) {
      scoreBandEl.classList.add("band-balanced");
    } else {
      scoreBandEl.classList.add("band-strong");
    }
